...
complete -c carthage -n '__fish_prog_using_subcommand bootstrap' -l configuration -r
...
complete -c carthage -n '__fish_prog_using_subcommand build' -l configuration -r
...
complete -c carthage -n '__fish_prog_using_subcommand update' -l configuration -r
