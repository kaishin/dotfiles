...
if !has('gui_running')
  if exists("g:base16_shell_path")
    execute "silent !/bin/sh ".g:base16_shell_path."/AtelierSulphurpoolDark.".&background.".sh"
  endif
endif
...
hi clear
syntax reset
let g:colors_name = "AtelierSulphurpoolDark"
...
hi TermCursorNC ctermfg=247    ctermbg=38     guifg=s:gui05 guibg=s:gui0C guisp=NONE cterm=NONE gui=NONE
