...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
  ...
  call <SID>X("AirlineStandard", s:window, s:dark, "")
  call <SID>X("AirlineNormal", s:green, "", "")
  call <SID>X("AirlineModified", s:foreground, "", "")
  call <SID>X("AirlineInsert", s:aqua, "", "")
  call <SID>X("AirlineReplace", s:red, "", "")
  call <SID>X("AirlineVisual", s:purple, "", "")
  call <SID>X("AirlineInactive", s:selection, "", "")
